...
# CREATE FOREIGN KEYS
songplay_table_FK1 = ("ALTER TABLE songplays ADD CONSTRAINT FK_songplays__start_time "
                      "FOREIGN KEY (start_time) REFERENCES time (start_time);")
songplay_table_FK2 = ("ALTER TABLE songplays ADD CONSTRAINT FK_songplays__user_id "
...
drop_table_queries = [songplay_table_drop,
                      ...
                      artist_table_drop,
                      time_table_drop]
create_FK_queries = [songplay_table_FK1,
                    songplay_table_FK2]