...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id int, start_time timestamp, user_id int, level varchar, \
                                            song_id varchar, artist_id varchar, session_id int, location varchar, user_agent text);")
...
artist_table_create = ("CREATE TABLE IF NOT EXISTS artists (artist_id varchar, name varchar, location varchar, lattitude varchar, longitude varchar);")
